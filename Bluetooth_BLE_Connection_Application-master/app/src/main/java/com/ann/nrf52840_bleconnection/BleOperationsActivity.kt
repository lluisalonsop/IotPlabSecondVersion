...
import com.ann.nrf52840_bleconnection.ConnectionEventListener
import com.ann.nrf52840_bleconnection.ConnectionManager
import com.ann.nrf52840_bleconnection.isIndicatable
import com.ann.nrf52840_bleconnection.isNotifiable
import com.ann.nrf52840_bleconnection.isReadable
import com.ann.nrf52840_bleconnection.isWritable
import com.ann.nrf52840_bleconnection.isWritableWithoutResponse
import com.ann.nrf52840_bleconnection.toHexString
    ...
    private val connectionEventListener by lazy {
        ConnectionEventListener().apply {
            ...
            onCharacteristicChanged = { _, characteristic ->
                ...
                var hexval = Integer.decode(characteristic.value.toHexString())
                if (countervalue == 0){
                    safely = hexval
                    countervalue += 1
                }else{
                    val temperature  = mutableListOf<Float>()
                    val humidity = mutableListOf<Float>()
                    temperature.add(safely.toFloat())
                    humidity.add(hexval.toFloat())
